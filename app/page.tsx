      ...
      <div className={`${isSidebarOpen ? 'w-64' : 'w-0'} bg-gray-900 text-white transition-all duration-300 flex flex-col overflow-hidden`}>
        ...
        <div className="p-4 border-t border-gray-800">
             <form action={async () => {
                ...
                <button type="submit" className="w-full text-left text-gray-400 hover:text-white text-sm flex items-center gap-2">
        ...
        {currentChatId ? (
            ...
            <div className="flex items-center justify-center h-full text-gray-500">
                <div className="text-center">
                    <h2 className="text-2xl font-bold mb-4">Welcome to NotebookLM Clone</h2>
                    <p className="mb-8">Select a chat from the sidebar or create a new one to get started.</p>
                    <button 
                        onClick={createNewChat}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
                    <div className="lg:col-span-1 flex flex-col gap-4 max-h-full overflow-y-auto">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                            <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Sources</h2>
                            ...
                            <div className="mt-4 space-y-2 max-h-[300px] overflow-y-auto">
                                {uploadedFiles.map((file, idx) => (
                                    <div key={idx} className="flex items-center justify-between gap-2 p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg text-sm text-gray-700 dark:text-gray-300 group">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 space-y-4">
                            ...
                            {isLoading && (
                                <div className="flex justify-start">
                                    <div className="bg-gray-100 dark:bg-gray-700 rounded-2xl px-4 py-3">Typing...</div>
                                </div>
                            )}
                        </div>
