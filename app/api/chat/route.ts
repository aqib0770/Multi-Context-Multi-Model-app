...
export async function POST(req: Request){
    ...
    const userQuery = lastMessage.parts.find((part: any) => part.type === 'text')?.text || ''
    ...
    const result = streamText({
        ...
        system: "You are a helpful assistant. Answer the user's questions based on the provided context from uploaded documents. If no context is provided, answer based on your general knowledge.",
